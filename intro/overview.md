...
下一步你可以通过[安装 Scrapy](https://stevenzhao.gitbooks.io/scrapy-chinese/content/intro/install.html), [Scrapy 入门](https://stevenzhao.gitbooks.io/scrapy-chinese/content/intro/tutorial.html)学习如何在 scrpay 项目中组织代码，你也可以[加入社区](http://scrapy.org/community/)。感谢你的阅读！
